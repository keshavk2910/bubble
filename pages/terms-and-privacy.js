        ...
        <div className='max-w-2xl'>
          ...
          <section id='introduction' className='mb-16'>
            ...
            <div className='space-y-6 text-gray-700 text-base font-normal font-sans leading-normal'>
              <p>
                ...
                <span>&quot;Terms&quot;</span>) govern your access to and use of
              ...
              <p>
                ...
                Services. Our Privacy Policy describes how we handle the
              ...
              <div className='flex gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-700 text-base font-normal font-sans leading-normal'>
                    ...
                    and understood these Terms and agree to be bound by them. If
                    you are using our Services on behalf of a company,
          ...
          <section id='definitions' className='mb-16'>
            ...
            <p className='text-gray-700 text-base font-normal font-sans leading-normal mb-6'>
              Throughout these Terms, we use certain defined terms. To help you
              understand these Terms, we&apos;ve defined these terms below:
            </p>
            ...
            <div className='space-y-8'>
                ...
                <div className='space-y-3 ml-4'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <p className='text-gray-700 text-base font-normal font-sans leading-normal'>
                      ...
                      anyone&apos;s use or enjoyment of the Services, or which
                      may harm CompanyName or users of the Services.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='bg-blue-50 rounded-xl border border-blue-200 p-6'>
                ...
                <p className='text-gray-700 text-base font-normal font-sans leading-normal'>
                  ...
                  display on or through our Services. By submitting, posting, or
                  displaying Content on or through our Services, you grant us a
                ...
                <div className='space-y-3 ml-4'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <p className='text-gray-700 text-base font-normal font-sans leading-normal'>
                      ...
                      similar tracking technologies to collect information about
                      your browsing activities over time and across different
                      websites.
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className='space-y-3 ml-4'>
                  ...
                  <div className='flex gap-2'>
                    <div className='w-1 h-1 bg-gray-600 rounded-full mt-3 flex-shrink-0'></div>
                    <p className='text-gray-700 text-base font-normal font-sans leading-normal'>
                      To send administrative messages, such as updates, security
          ...
          <section id='legal-compliance' className='mb-16'>
            ...
            <p className='text-gray-700 text-base font-normal font-sans leading-normal mb-8'>
              ...
              regulations. This section outlines our legal obligations and your
                ...
                <div className='flex gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-700 text-base font-normal font-sans leading-normal'>
                      ...
                      faith that such disclosure is necessary to (a) comply with
                      relevant laws or to respond to subpoenas or warrants
                      served on us; or (b) protect or defend the rights,
                      property, or safety of CompanyName, users of the Services,
                      or others.
                    </p>
                  </div>
                </div>
                ...
                <div className='flex gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-700 text-base font-normal font-sans leading-normal'>
                      ...
                      notification through a prominent notice on our Services or
                      by sending an email to the email address associated with
                      your account.
                    </p>
                  </div>
                </div>
          ...
          <section className='mb-16'>
            ...
            <p className='text-gray-700 text-base font-normal font-sans leading-normal mb-6'>
              ...
              registration, you will be asked to explicitly accept these terms.
            </p>
