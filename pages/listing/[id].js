    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.error === 'Cannot contact yourself') {
          ...
          alert(
            data.details || 'Failed to start conversation. Please try again.'
          );
        }
      }
    } catch (error) {
      ...
      alert(
        'Failed to contact seller. Please check your connection and try again.'
      );
    }
  };
      ...
      <Head>
        ...
        <meta
          ...
          content={
            ...
            'View listing details, contact seller, and find related equipment.'
          }
        />
        <meta
          name='keywords'
          content={`${listing?.category || ''}, pressure washing, ${
            listing?.condition || ''
