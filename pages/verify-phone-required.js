        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-base font-normal font-sans leading-normal">
              To ensure the security of our marketplace, please verify your phone number before accessing your account.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-gray-900 text-sm">{userProfile?.full_name}</span>
            </div>
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-900 text-sm">{userProfile?.email}</span>
              </div>
            </div>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-900 text-sm">{userProfile?.phone}</span>
              </div>
            </div>
          </div>
