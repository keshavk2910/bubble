...
export default function PostNewListing() {
  ...
  if (!userProfile?.email_verified) {
    return (
      <DashboardLayout title="Email Verification Required" subtitle="Verify your email to create listings">
        <div className="max-w-2xl mx-auto text-center py-12">
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-8">
            ...
            <p className="text-yellow-700 text-base font-normal font-sans mb-6">
              To create listings on our marketplace, you need to verify your email address.
            </p>
            <button
  ...
  if (submitSuccess) {
    return (
      <DashboardLayout title="Listing Submitted" subtitle="Your listing has been submitted successfully">
        <div className="max-w-2xl mx-auto text-center py-12">
          <div className="bg-green-50 border border-green-200 rounded-xl p-8">
            ...
            <p className="text-green-700 text-base font-normal font-sans mb-4">
              Your listing has been submitted for review. Our admin team will review it and approve it within 24 hours.
            </p>
  ...
  return (
    <DashboardLayout title="Post New Listing" subtitle="Create a new listing to sell your equipment or business">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-base font-normal font-sans leading-normal">
            Complete the form below to list your item on Bin Cleaning Classifieds
          </p>
        </div>
