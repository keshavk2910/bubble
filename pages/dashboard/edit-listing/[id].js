...
export default function EditListing() {
  ...
  if (isLoading) {
    return (
      <DashboardLayout title="Edit Listing" subtitle="Update your listing information">
  ...
  if (submitSuccess) {
    return (
      <DashboardLayout title="Listing Updated" subtitle="Your listing has been updated successfully">
