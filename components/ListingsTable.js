        ...
        <table className='w-full'>
          <thead className='bg-gray-50'>
            <tr>
              ...
              <th className='text-center px-4 py-3 text-gray-600 text-sm font-normal font-sans leading-tight'>
                Featured
              </th>
              <th className='text-right px-4 py-3 text-gray-600 text-sm font-normal font-sans leading-tight'>
                Actions
              </th>
            </tr>
          </thead>
            ...
            {listings.length === 0 ? (
              ...
              listings.map((listing) => (
                ...
                >
                  ...
                  <td className='px-4 py-3'>
                    {listing.display_id || `BZ-${listing.listing_id}`}
                  </td>
                  <td className='px-4 py-3'>
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      <div className='relative'>
                        <select
                          ...
                          className={`appearance-none border rounded-full px-3 py-1 pr-8 text-xs font-medium cursor-pointer focus:outline-none ${getStatusColor(
                            listing.status
                          )}`}
                        >
                  ...
                  <td className='px-4 py-3 text-center'>
                    ...
                    <button
                      onClick={() =>
                        onToggleFeatured && onToggleFeatured(listing)
                      }
                  ...
                  <td className='px-4 py-3 text-right'>
                    <div className='flex items-center justify-end gap-1'>
                      ...
                      {listing.status === 'deleted' ? (
                        <button
                          onClick={() =>
                            setRecoverConfirm({ show: true, listing })
                          }
                          className='p-1 text-green-600 hover:text-green-700 transition-colors'
          ...
          <div className='bg-white rounded-xl p-6 max-w-md w-full'>
            <div className='text-center mb-6'>
              ...
              <p className='text-gray-500 text-sm font-normal font-sans'>
                This will hide the listing from users. You can recover it later
                if needed.
              </p>
            </div>
